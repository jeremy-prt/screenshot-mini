...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'hero.subtitle': {
    en: 'A lightweight screenshot tool for macOS. Capture, annotate, extract text and beautify, all in one click.',
    fr: 'Un outil de capture d\'écran léger pour macOS. Capturez, annotez, extrayez du texte et embellissez, en un clic.',
    es: 'Una herramienta ligera de capturas para macOS. Captura, anota, extrae texto y embellece, en un clic.',
    de: 'Ein leichtes Screenshot-Tool für macOS. Erfassen, kommentieren, Text extrahieren und verschönern, mit einem Klick.'
  },
  ...
  'section.ocr.desc': { en: 'Select any area, Orby extracts the text instantly and copies it to your clipboard. Works offline, no setup needed.', fr: 'Sélectionnez une zone, Orby extrait le texte instantanément et le copie dans votre presse-papier. Fonctionne hors-ligne, aucune configuration.', es: 'Selecciona cualquier zona, Orby extrae el texto al instante y lo copia al portapapeles. Funciona sin conexión, sin configuración.', de: 'Wählen Sie einen Bereich, Orby extrahiert den Text sofort und kopiert ihn in die Zwischenablage. Funktioniert offline, keine Einrichtung nötig.' },
  ...
  'section.background.desc': { en: 'Add gradient backgrounds, padding, rounded corners and shadows. Make every screenshot look polished.', fr: 'Ajoutez des dégradés, du padding, des coins arrondis et des ombres. Rendez chaque capture soignée.', es: 'Añade fondos degradados, padding, esquinas redondeadas y sombras. Haz que cada captura luzca impecable.', de: 'Fügen Sie Verlaufshintergründe, Abstand, abgerundete Ecken und Schatten hinzu. Jeder Screenshot sieht perfekt aus.' },
  'section.history.title': { en: 'Capture history', fr: 'Historique des captures', es: 'Historial de capturas', de: 'Erfassungsverlauf' },
  'section.history.desc': { en: 'Browse your recent captures, re-edit them, copy or drag & drop anywhere. Always at hand.', fr: 'Parcourez vos captures récentes, ré-éditez-les, copiez ou glissez-déposez n\'importe où. Toujours à portée de main.', es: 'Navega por tus capturas recientes, reedítalas, copia o arrastra a cualquier lugar. Siempre a mano.', de: 'Durchsuchen Sie Ihre letzten Erfassungen, bearbeiten Sie sie erneut, kopieren oder ziehen Sie sie überall hin. Immer griffbereit.' },
